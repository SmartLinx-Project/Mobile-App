...
class ScheduleBodyLightWidget extends StatefulWidget {
  final DeviceLight device;
  const ScheduleBodyLightWidget({
    super.key,
    required this.device,
  });

  @override
  State<ScheduleBodyLightWidget> createState() =>
      _ScheduleBodyLightWidgetState();
}

class _ScheduleBodyLightWidgetState extends State<ScheduleBodyLightWidget> {
  ...
  void initSchedule() {
    ...
    List<dynamic> listPeriodicity =
        DeviceLightHive.instance.getDevicesFromID(deviceID).periodicity;
    String day;
  ...
  void saveChanges() async {
    ...
    if (await HttpService().setDevice(
      ...
      DeviceLightHive.instance.setStartTime(deviceID, startTime);
      DeviceLightHive.instance.setEndTime(deviceID, endTime);
      DeviceLightHive.instance.setPeriodicity(deviceID, newPeriodicity);
      DeviceLightHive.instance.setSchedState(deviceID, true);
    }
    hideLoadingDialog();
  }
