...
import 'package:smartlinx/pages/smartPlug/widget/schedulebody_wid.dart';
...
class SmartPlugBodyPopup extends StatefulWidget {
  final DevicePlug device;
  const SmartPlugBodyPopup({super.key, required this.device});

  @override
  State<SmartPlugBodyPopup> createState() => _SmartPlugBodyPopupState();
}

class _SmartPlugBodyPopupState extends State<SmartPlugBodyPopup> {
